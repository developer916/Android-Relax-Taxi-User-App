...
public interface ApiInterface {
    ...
    Observable<Message> payment(@Field("request_id") Integer params);
    ...
    Observable<Object> addMoney(@FieldMap HashMap<String, Object> params);
    ...
    default Observable<List<Wallet>> wallet() {
        return null;
    }
